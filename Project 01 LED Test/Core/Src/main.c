...
/**
  ...
  * Program Objective : Set a LED on and another LED in Toogle mode.
...
int main(void)
{
  ...
  HAL_GPIO_WritePin(LED_1_GPIO_Port, LED_1_Pin, 1);    // LED 1 connected with PA1 pin set high

  while (1)
  {

	  HAL_GPIO_TogglePin(LED_BUILT_IN_GPIO_Port, LED_BUILT_IN_Pin);   // ON Board LED  connected with PC13 set to toogle
